...
Future<List<dynamic>?> getColaboradores(String? nome, String campo) async {
  final lowCampo = campo.toLowerCase();
  // URL da API
  final String url =
      'https://mmzhpywuzkxppbwsalry.supabase.co/rest/v1/vw_colabs?$lowCampo=ilike.*$nome*&select=*';
