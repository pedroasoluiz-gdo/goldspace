...
Future<List<dynamic>?> getEmpresas(String? descricao) async {
  // URL da API
  final String url =
      'https://mmzhpywuzkxppbwsalry.supabase.co/rest/v1/d_empresas?grupo=ilike.*$descricao*&status=eq.true&select=*&order=grupo.asc';
