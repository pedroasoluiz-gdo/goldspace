...
Future<List<dynamic>?> getCidades(String? descricao) async {
  // URL da API
  final String url =
      'https://mmzhpywuzkxppbwsalry.supabase.co/rest/v1/d_cidades?descricao=ilike.*$descricao*&select=*&order=descricao.asc';
