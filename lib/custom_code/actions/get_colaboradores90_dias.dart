...
Future<List<dynamic>?> getColaboradores90Dias(
    String? nome, String campo) async {
  final lowCampo = campo.toLowerCase();
  // URL da API
  final String url =
      'https://mmzhpywuzkxppbwsalry.supabase.co/rest/v1/vw_colabs_90_days?$lowCampo=ilike.*$nome*&select=*';
