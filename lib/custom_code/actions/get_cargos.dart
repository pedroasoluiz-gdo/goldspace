...
Future<List<dynamic>?> getCargos(String? descricao) async {
  // if (descricao!.length >= 3) {
  final String url =
      'https://mmzhpywuzkxppbwsalry.supabase.co/rest/v1/d_cargos?descricao=ilike.*$descricao*&select=*&status=eq.true&order=descricao.asc';
