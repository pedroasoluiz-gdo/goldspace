...
Future<List<dynamic>?> getGestor(String? descricao) async {
  final String url =
      'https://mmzhpywuzkxppbwsalry.supabase.co/rest/v1/d_gestor?nome=ilike.*$descricao*&ativo=eq.true&select=*&order=nome.asc';
