...
Future<List<dynamic>?> filterAPE(
  ...
  if (periodo.isNotEmpty) queryParams.add('periodo=eq.$periodo');
  ...
  queryParams.add('respondido=eq.$ativoStr');
  queryParams.add('select=*&order=vencimento.desc');

  // Construindo a URL da API
  final String url =
      'https://mmzhpywuzkxppbwsalry.supabase.co/rest/v1/vw_c_ape_envio?' +
          queryParams.join('&');
