...
class CDesligamentoProducaoTable
    extends SupabaseTable<CDesligamentoProducaoRow> {
  @override
  String get tableName => 'c_desligamento_producao';

  @override
  CDesligamentoProducaoRow createRow(Map<String, dynamic> data) =>
      CDesligamentoProducaoRow(data);
}

class CDesligamentoProducaoRow extends SupabaseDataRow {
  CDesligamentoProducaoRow(super.data);

  @override
  SupabaseTable get table => CDesligamentoProducaoTable();
