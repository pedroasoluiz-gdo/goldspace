...
class Ape90Struct extends BaseStruct {
  Ape90Struct({
    String? nome,
    int? fkGestor,
    String? gestor,
  ...
  static Ape90Struct fromMap(Map<String, dynamic> data) => Ape90Struct(
  ...
  static Ape90Struct? maybeFromMap(dynamic data) =>
      data is Map ? Ape90Struct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static Ape90Struct fromSerializableMap(Map<String, dynamic> data) =>
      Ape90Struct(
  ...
  @override
  String toString() => 'Ape90Struct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is Ape90Struct &&
        nome == other.nome &&
