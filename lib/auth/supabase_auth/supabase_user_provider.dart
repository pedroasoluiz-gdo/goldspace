...
class GoldTalentSupabaseUser extends BaseAuthUser {
  GoldTalentSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> goldTalentSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = GoldTalentSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
