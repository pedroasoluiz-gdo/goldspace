...
import 'curso_editar_model.dart';
export 'curso_editar_model.dart';

class CursoEditarWidget extends StatefulWidget {
  const CursoEditarWidget({
    super.key,
    int? fkFormacao,
    int? idColab,
  })  : fkFormacao = fkFormacao ?? 0,
        idColab = idColab ?? 0;
  ...
  @override
  State<CursoEditarWidget> createState() => _CursoEditarWidgetState();
}

class _CursoEditarWidgetState extends State<CursoEditarWidget> {
  late CursoEditarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CursoEditarModel());

    _model.instituicaoFocusNode ??= FocusNode();

    _model.diplomaFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: FutureBuilder<List<CColaboradoresCursosRow>>(
        future: CColaboradoresCursosTable().querySingleRow(
          queryFn: (q) => q.eq(
            'id',
            widget.fkFormacao,
          ),
        ...
        builder: (context, snapshot) {
          ...
          List<CColaboradoresCursosRow>
              overlayCreateMessageCColaboradoresCursosRowList = snapshot.data!;

          final overlayCreateMessageCColaboradoresCursosRow =
              overlayCreateMessageCColaboradoresCursosRowList.isNotEmpty
                  ? overlayCreateMessageCColaboradoresCursosRowList.first
                  : null;
                                                          ...
                                                          await CColaboradoresCursosTable()
                                                            ...
                                                            data: {
                                                              ...
                                                              'fkUser': widget
                                                                  .idColab,
                                                              'nome':
                                                                  overlayCreateMessageCColaboradoresCursosRow
                                                                      ?.nome,
                                                              'organizacaoEmissora':
                                                                  overlayCreateMessageCColaboradoresCursosRow
                                                                      ?.organizacaoEmissora,
                                                              'emissao': supaSerialize<
                                                                      DateTime>(
                                                                  functions.formatDateString(_model
                                                        ...
                                                        TextFormField(
                                                          controller: _model
                                                            ...
                                                            text:
                                                                valueOrDefault<
                                                                    String>(
                                                              '${overlayCreateMessageCColaboradoresCursosRow?.tempo.toString()}',
                                                              'null',
                                                            ),
                                                          ),
                                                          focusNode: _model
