...
class _FormacaoAcademicaWidgetState extends State<FormacaoAcademicaWidget> {
  ...
  void initState() {
    ...
    _model.instituicaoTextController ??= TextEditingController();
    _model.instituicaoFocusNode ??= FocusNode();

    _model.diplomaTextController ??= TextEditingController();

    _model.areaEstudoTextController ??= TextEditingController();
