...
import '/gold_space_adm/paginas/pessoas/ape/a_p_e_inserir/a_p_e_inserir_widget.dart';
import '/gold_space_adm/paginas/pessoas/ape/detalhes/detalhes_widget.dart';
import '/custom_code/actions/index.dart' as actions;
import '/flutter_flow/custom_functions.dart' as functions;
import 'package:auto_size_text/auto_size_text.dart';
import 'package:flutter/material.dart';
import 'package:webviewx_plus/webviewx_plus.dart';
import 'ape_model.dart';
export 'ape_model.dart';

class ApeWidget extends StatefulWidget {
  const ApeWidget({super.key});

  @override
  State<ApeWidget> createState() => _ApeWidgetState();
}

class _ApeWidgetState extends State<ApeWidget> {
  late ApeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ApeModel());
    ...
    _model.txtPeriodoTextController ??= TextEditingController();
                        ...
                        children: [
                          wrapWithModel(
                            ...
                            child: const CabecalhoWidget(
                              header1: 'Colaborador',
                              tittle: 'Avaliação do Período de Experiência',
                            ),
                          ),
                          Expanded(
                            child: Padding(
                                                                      ...
                                                                      child: Autocomplete<
                                                                        ...
                                                                        optionsViewBuilder: (context,
                                                                          ...
                                                                          return AutocompleteOptionsList(
                                                                            textFieldKey:
                                                                                _model.txtPeriodoKey,
                                                                            textController:
                                                                                _model.txtPeriodoTextController!,
                                                                            options:
                                                                                options.toList(),
                                                                            onSelected:
                                                                                onSelected,
                                                                        ...
                                                                        onSelected:
                                                                            (String
                                                                                selection) {
                                                                          safeSetState(() =>
                                                                              _model.txtPeriodoSelectedOption = selection);
                                                                        ...
                                                                        fieldViewBuilder:
                                                                          ...
                                                                          return TextFormField(
                                                                            ...
                                                                            validator:
                                                                                _model.txtPeriodoTextControllerValidator.asValidator(context),
                                                                          );
                                                                        },
                                                                      ),
                                                                    ),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            color:
                                                                              ...
                                                                              _model.status ? FlutterFlowTheme.of(context).secondaryBackground : const Color(0x00000000),
                                                                              FlutterFlowTheme.of(context).secondaryBackground,
                                                                            ),
                                                                            borderRadius:
                                                                      ...
                                                                      Flexible(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            decoration:
                                                                                BoxDecoration(
                                                                              color: !_model.status ? FlutterFlowTheme.of(context).secondaryBackground : const Color(0x00000000),
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            if (!getJsonField(
                                                                                ...
                                                                                !functions.maiorQueHoje(getJsonField(
                                                                                  dataItem,
                                                                                  r'''$.vencimento''',
                                                                                ).toString()))
                                                                              Icon(
