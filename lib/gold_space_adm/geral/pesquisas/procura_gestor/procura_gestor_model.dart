...
import 'procura_gestor_widget.dart' show ProcuraGestorWidget;
import 'package:flutter/material.dart';

class ProcuraGestorModel extends FlutterFlowModel<ProcuraGestorWidget> {
  ...
  Future loading(
    ...
    resultado = await actions.getGestor(
      descricao,
    );
