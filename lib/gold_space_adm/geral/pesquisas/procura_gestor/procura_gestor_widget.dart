...
import 'procura_gestor_model.dart';
export 'procura_gestor_model.dart';

class ProcuraGestorWidget extends StatefulWidget {
  const ProcuraGestorWidget({super.key});

  @override
  State<ProcuraGestorWidget> createState() => _ProcuraGestorWidgetState();
}

class _ProcuraGestorWidgetState extends State<ProcuraGestorWidget> {
  late ProcuraGestorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProcuraGestorModel());
