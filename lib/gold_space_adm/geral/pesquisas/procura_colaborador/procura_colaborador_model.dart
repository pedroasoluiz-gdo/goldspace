...
import 'procura_colaborador_widget.dart' show ProcuraColaboradorWidget;
import 'package:flutter/material.dart';

class ProcuraColaboradorModel
    extends FlutterFlowModel<ProcuraColaboradorWidget> {
  ...
  Future loading(
    ...
    resultado = await actions.getColaboradores(
