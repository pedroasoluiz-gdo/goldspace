...
import 'procura_cargos_model.dart';
export 'procura_cargos_model.dart';

class ProcuraCargosWidget extends StatefulWidget {
  const ProcuraCargosWidget({super.key});

  @override
  State<ProcuraCargosWidget> createState() => _ProcuraCargosWidgetState();
}

class _ProcuraCargosWidgetState extends State<ProcuraCargosWidget> {
  late ProcuraCargosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProcuraCargosModel());
