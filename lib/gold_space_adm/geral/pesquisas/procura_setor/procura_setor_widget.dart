...
import 'procura_setor_model.dart';
export 'procura_setor_model.dart';

class ProcuraSetorWidget extends StatefulWidget {
  const ProcuraSetorWidget({super.key});

  @override
  State<ProcuraSetorWidget> createState() => _ProcuraSetorWidgetState();
}

class _ProcuraSetorWidgetState extends State<ProcuraSetorWidget> {
  late ProcuraSetorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProcuraSetorModel());
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      Builder(
                        builder: (context) {
                          final setor = _model.apiResult.map((e) => e).toList();
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, setorIndex) {
                              final setorItem = setor[setorIndex];
                              return Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    18.0, 0.0, 18.0, 0.0),
                                child: InkWell(
