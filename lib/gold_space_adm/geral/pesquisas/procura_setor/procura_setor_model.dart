...
import 'procura_setor_widget.dart' show ProcuraSetorWidget;
import 'package:flutter/material.dart';

class ProcuraSetorModel extends FlutterFlowModel<ProcuraSetorWidget> {
  ...
  Future loading(
    ...
    resultado = await actions.getSetor(
