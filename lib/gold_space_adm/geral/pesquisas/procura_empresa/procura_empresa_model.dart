...
import 'procura_empresa_widget.dart' show ProcuraEmpresaWidget;
import 'package:flutter/material.dart';

class ProcuraEmpresaModel extends FlutterFlowModel<ProcuraEmpresaWidget> {
  ...
  Future loading(
    ...
    resultado = await actions.getEmpresas(
      descricao,
    );
